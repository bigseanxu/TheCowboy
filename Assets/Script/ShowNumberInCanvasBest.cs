...
public class ShowNumberInCanvasBest : MonoBehaviour {
	...
	void GenerateImageNumber(int n) {
		for (int i = 0; i < n; i++) {
			GameObject number = (GameObject) Instantiate ((GameObject) Resources.Load ("NumberBest"), new Vector3 (), new Quaternion());
